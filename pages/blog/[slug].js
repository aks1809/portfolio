  ...
  return (
    <>
      <NextSeo
        ...
        canonical={`https://akshaychaturvedi.id/blog/${metadata.slug}`}
        openGraph={{
          url: `https://akshaychaturvedi.id/blog/${metadata.slug}`,
          site_name: 'Akshay Chaturvedi',
          title: metadata.title,
          description: metadata.summary,
          type: 'article',
          article: {
            authors: ['Akshay Chaturvedi'],
        ...
        additionalMetaTags={[
          { property: 'twitter:card', content: 'summary_large_image' },
          {
            ...
            content: `https://akshaychaturvedi.id/blog/${metadata.slug}`,
          },
      ...
      <ArticleJsonLd
        ...
        authorName="Akshay Chaturvedi"
        publisherName="Akshay Chaturvedi"
