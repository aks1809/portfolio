...
export default function Index({ articles }) {
  ...
  return (
    <Container>
      <Head>
        <title>Blog - Akshay Chaturvedi</title>
        <meta name="title" content="Blog - Akshay Chaturvedi" />
        <meta
          name="description"
        ...
        <meta property="og:url" content="https://akshaychaturvedi.id/blog" />
        <meta property="og:title" content="Blog - Akshay Chaturvedi" />
        <meta
        ...
        <meta property="twitter:url" content="https://akshaychaturvedi.id/" />
        <meta property="twitter:title" content="Blog - Akshay Chaturvedi" />
        <meta
